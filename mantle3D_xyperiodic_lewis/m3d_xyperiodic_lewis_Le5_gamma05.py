...
if not restart:
    ...
    write, initial_timestep = solver.load_state('checkpoints_Le5_gamma05/checkpoints_Le5_gamma05_s1.h5')

# Analysis
snapshots = solver.evaluator.add_file_handler('snapshots_Le5_gamma05', iter=100, max_writes=10)
...
snapshots_nonlinear = solver.evaluator.add_file_handler('snapshots_nonlinear_Le5_gamma05', iter=10, max_writes=200)
...
# Checkpoints
checkpoints = solver.evaluator.add_file_handler('checkpoints_Le5_gamma05', sim_dt=0.5, max_writes=1, mode=file_handler_mode)
