...
if not restart:
    ...
    write, initial_timestep = solver.load_state('checkpoints_Le10_gamma1/checkpoints_Le10_gamma1_s1.h5')

# Analysis
snapshots = solver.evaluator.add_file_handler('snapshots_Le10_gamma1', iter=100, max_writes=10)
...
snapshots_nonlinear = solver.evaluator.add_file_handler('snapshots_nonlinear_Le10_gamma1', iter=10, max_writes=200)
...
# Checkpoints
checkpoints = solver.evaluator.add_file_handler('checkpoints_Le10_gamma1', sim_dt=0.1, max_writes=1, mode=file_handler_mode)
