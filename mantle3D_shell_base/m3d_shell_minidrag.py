...
if not restart:
    ...
    write, initial_timestep = solver.load_state('checkpoints_md/checkpoints_md_s1.h5')

# Analysis
snapshots = solver.evaluator.add_file_handler('snapshots_md', iter=100, max_writes=10)
...
snapshots_nonlinear = solver.evaluator.add_file_handler('snapshots_nonlinear_md', iter=10, max_writes=200)
...
# Checkpoints
checkpoints = solver.evaluator.add_file_handler('checkpoints_md', sim_dt=max_timestep*1000, max_writes=1, mode=file_handler_mode)
