...
#    C['g'] = 1
    ...
    write, initial_timestep = solver.load_state('checkpoints/checkpoints_s18.h5')
...
# Checkpoints
checkpoints = solver.evaluator.add_file_handler('checkpoints', sim_dt=0.1, max_writes=1, mode=file_handler_mode)
