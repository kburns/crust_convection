...
#    C['g'] = 1
    ...
    write, initial_timestep = solver.load_state('checkpoints_RaT30k/checkpoints_s1.h5')

# Analysis
snapshots = solver.evaluator.add_file_handler('snapshots_RaT30k', iter=100, max_writes=10)
...
# Checkpoints
checkpoints = solver.evaluator.add_file_handler('checkpoints_RaT30k', sim_dt=0.1, max_writes=1, mode=file_handler_mode)
