...
if not restart:
    ...
    write, initial_timestep = solver.load_state('checkpoints_CRa22k_E8_gamma10/checkpoints_s1.h5')
...
# Checkpoints
checkpoints = solver.evaluator.add_file_handler('checkpoints_CRa22k_E8_gamma10', sim_dt=max_timestep*1000, max_writes=1, mode=file_handler_mode)
