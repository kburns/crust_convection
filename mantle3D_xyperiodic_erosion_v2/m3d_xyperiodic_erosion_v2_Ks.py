...
Ks = rain_erosion*D_scale/kappa_scale # rain_erosion*D_scale/kappa_scale
...
if not restart:
    ...
    write, initial_timestep = solver.load_state('checkpoints_Ks/checkpoints_Ks_s2.h5')

# Analysis
snapshots = solver.evaluator.add_file_handler('snapshots_Ks/', iter=100, max_writes=10)
...
snapshots_nonlinear = solver.evaluator.add_file_handler('snapshots_nonlinear_Ks/', iter=10, max_writes=200)
...
# Checkpoints
checkpoints = solver.evaluator.add_file_handler('checkpoints_Ks/', sim_dt=1, max_writes=1, mode=file_handler_mode)
