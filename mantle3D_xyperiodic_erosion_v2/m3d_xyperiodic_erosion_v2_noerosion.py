...
problem.add_equation("T(z=Lz) = -h*dz(T)(z = Lz)")
# BC: continents on top
problem.add_equation("C(z=0) = 1")
problem.add_equation("C(z=Lz) = -h*dz(C)(z = Lz)")
# BC: rigid bottom
problem.add_equation("ez@u(z=0) = 0")

# BC: normal stress free top
problem.add_equation("p(z = Lz) + 2*dz(ez @ u)(z = Lz) = -h*dz(p)(z = Lz)")

# BC: stress free top, bottom
problem.add_equation("(ez@grad(u)@ex)(z=0) = 0")
problem.add_equation("(ez@grad(u)@ex)(z=Lz) = -h*dz((ez@grad(u)@ex))(z = Lz)")
problem.add_equation("(ez@grad(u)@ey)(z=0) = 0")
problem.add_equation("(ez@grad(u)@ey)(z=Lz) = -h*dz((ez@grad(u)@ey))(z = Lz)")
