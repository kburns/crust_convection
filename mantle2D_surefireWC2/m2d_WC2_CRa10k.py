...
# Analysis
snapshots = solver.evaluator.add_file_handler('snapshots_CRa10k', iter=100, max_writes=50)
...
# Checkpoints
checkpoints = solver.evaluator.add_file_handler('checkpoints_CRa10k', sim_dt=1.0, max_writes=1, mode=file_handler_mode)
