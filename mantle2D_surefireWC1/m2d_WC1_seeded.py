...
if not restart:
    ...
    write, initial_timestep = solver.load_state('checkpoints_seeded/checkpoints_s2.h5')

# Analysis
snapshots = solver.evaluator.add_file_handler('snapshots_seeded', iter=100, max_writes=50)
...
# Checkpoints
checkpoints = solver.evaluator.add_file_handler('checkpoints_seeded', sim_dt=1.0, max_writes=1, mode=file_handler_mode)
checkpoints.add_tasks(solver.state)

# CFL
CFL = d3.CFL(solver, initial_dt=1e-4, cadence=1, safety=0.25, threshold=0.05,
